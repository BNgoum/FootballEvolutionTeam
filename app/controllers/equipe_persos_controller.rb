class EquipePersosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @equipe_perso.save
        ...
        flash[:success] = "Ton équipe a bien été crée !"
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to equipe_persos_url, success: "L'équipe a bien été supprimé !" }
  ...
  private
    ...
    def equipe_perso_params
      params.require(:equipe_perso).permit(:nameteam, :nametrainer, :effectif, :pays, :statsgenerale, :argent, :image)
    end
